 ...
 * Message
 *
 * @ORM\Table(name="message", uniqueConstraints={@ORM\UniqueConstraint(name="idMessage", columns={"idMessage"})}, indexes={@ORM\Index(name="receiverREF", columns={"receiverREF"}), @ORM\Index(name="senderREF", columns={"senderREF"})})
 * @ORM\Entity
 */
class Message
{
