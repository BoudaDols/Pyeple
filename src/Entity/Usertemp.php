 ...
 * Usertemp
 *
 * @ORM\Table(name="usertemp", uniqueConstraints={@ORM\UniqueConstraint(name="special", columns={"special"}), @ORM\UniqueConstraint(name="UNIQ_8D93D649F85E0677", columns={"username"})})
 * @ORM\Entity
 */
class Usertemp
{
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="DateInscript", type="datetime", nullable=false, options={"default"="CURRENT_TIMESTAMP"})
     */
    private $dateinscript = 'CURRENT_TIMESTAMP';
